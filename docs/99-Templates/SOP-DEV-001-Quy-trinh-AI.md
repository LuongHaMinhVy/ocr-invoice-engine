...
2. **Viết Đặc tả (Spec):** Tạo file đặc tả thiết kế tại đường dẫn: `docs/03-Specs/SPEC-###-<ten-tinh-nang>.md`
...
1. **Tạo file Kế hoạch (Plan):** Tạo file tại: `docs/04-Development/PLAN-###-<ten-tinh-nang>.md`
...
4. **Tích xanh tiến độ:** Sau mỗi task hoàn thành, cập nhật trạng thái `- [x]` trong file `docs/04-Development/PLAN-###-<ten-tinh-nang>.md` và thực hiện `git commit`.
...
"1. BẮT BUỘC KHỞI ĐỘNG BẰNG BRAINSTORMING: Khi nhận bất kỳ yêu cầu viết code nào, tuyệt đối CẤM viết code ngay lập tức. Phải đặt câu hỏi làm rõ với người dùng, đề xuất 2-3 giải pháp và viết file Spec vào `docs/03-Specs/` trước.",

"2. BẮT BUỘC LẬP KẾ HOẠCH BITE-SIZED: Sau khi Spec được duyệt, viết file kế hoạch thực hiện vào `docs/04-Development/` chia nhỏ thành các task 2-5 phút. Mỗi task bắt buộc phải ghi rõ file cần tạo/sửa và code test mong muốn.",
